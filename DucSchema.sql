...
--
-- Host: localhost    Database: simpleducprofile
-- ------------------------------------------------------
...
--
-- Table structure for table `user_passcode`
--
...
CREATE TABLE `user_terms` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `u_email` varchar(500) NOT NULL,
  `terms` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
-- Dump completed on 2023-06-30 12:50:47

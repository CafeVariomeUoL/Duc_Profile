...
<div class="cardsLayout mt-3">
  <div class="row ">
    <div class="card" style="width: 100%;">
      ...
      <div class="card-body">
        This tool can be used to create a Digital Use Conditions profile for a given resource to describe its requirements for third party use.
      </div>
    </div>
  </div>
    ...
    <div class="card" style="width: 100%;">
      <div class="card-body">
        ...
        <div class="mt-2 text-center">
          For more information please contact <a href="" id="tonyb">Anthony Brookes</a> or <a href="" id="sgib">Spencer Gibson</a> regarding the DUC, or <a id="umar" href="">Umar Riaz</a> regarding supporting software.
